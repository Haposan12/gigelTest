    ...
    <div class="row h-100 justify-content-center align-items-center">
      <form class="col-5 box-shadow bg-white p-4" @submit.prevent="doRegister()">
        ...
        <div class="form-group">
          <input type="text" class="form-control" v-model="form.payload.name" placeholder="nama">
        ...
        <div class="form-group">
          <input type="text" class="form-control" v-model="form.payload.phone_number" placeholder="nomor handphone">
        ...
        <p>
          <span>Sudah memiliki akun?</span> <router-link :to="{name: 'Login'}">Login</router-link>
        </p>
      </form>   
    </div>
  </div>
