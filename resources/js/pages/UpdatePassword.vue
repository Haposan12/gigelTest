  ...
  <div>
    <form class="box-shadow bg-white p-4" @submit.prevent="doUpdate()">
      ...
      <div class="form-group">
        <input type="password" class="form-control" v-model="form.payload.old_password" placeholder="password lama">
        <span class="text-danger" v-if="error.old_password">{{error.old_password[0]}}</span>
      </div>
      <div class="form-group">
        <input type="password" class="form-control" v-model="form.payload.password" placeholder="password baru">
